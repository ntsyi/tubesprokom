...
background-image: url("https://wallpapercave.com/wp/wp1971796.jpg");
...
def home():
    ...
    st.markdown("<h1 style='text-align: center; color: black;'> Natasya Nurazizah B. </h1>", unsafe_allow_html=True)
