...
st.title("Aplikasi Data Produksi Minyak Seluruh Dunia")
st.write("Natasya Nurazizah Bachrul - 12220056")
...
#GUI B
st.header("Beberapa Negara dengan Produksi Minyak Terbesar")
st.write("Menampilkan grafik beberapa besar negara dengan produksi minyak terbesar sepanjang tahun dan pada tahun tertentu")
...
st.header("Informasi Negara dengan Produksi Minyak Mentah Terbesar dan Terkecil")
